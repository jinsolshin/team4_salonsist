...
<body>
	...
	if(cnt == 0){
		dao.insertBooking(v);
		out.print("예약이 완료되었습니다.");
	}else{
		out.print("해당 시간대는 예약이 불가합니다. 다른 시간대를 선택해주세요!");
	}
	%>
	
	<button type="button" onclick="location.href='./Salon_Main.jsp'">메인</button>
	<button type="button" onclick="location.href='./Salon_Book.jsp'">예약하기</button>
