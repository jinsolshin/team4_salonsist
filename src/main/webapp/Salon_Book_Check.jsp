			...
			<form action="Salon_Book_CheckList.jsp" class="text-center">
				<fieldset>
					...
					<div class="form-group text-start">
				    	...
				    	<input type="text" class="form-control" name="booker_name" id="booker_name" aria-describedby="booker_name_help" placeholder="Enter Name">
					...
					<div class="form-group text-start">
				    	...
				    	<input type="number" class="form-control" name="booker_phone" id="booker_phone" aria-describedby="booker_phone_help" placeholder="Enter Phone Number">
					...
					<div class="form-group text-start">
				    	...
				    	<input type="password" class="form-control" name="booker_pwd" id="booker_pwd" aria-describedby="booker_pwd_help" placeholder="Enter Password">
